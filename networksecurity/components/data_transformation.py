...
class DataTransformation:
    ...
    def get_data_transformer_object(self)->Pipeline:
        """
        It initializes the KNNImputer with the parameters specified in the DATA_TRANSFORMATION_IMPUTER_PARAMS constant and returns a Pipeline object that contains the KNNImputer as a step.
        Args:
        cls: DataTransformation 
        Returns:
        Pipeline: A scikit-learn Pipeline object that contains the KNNImputer as a step.
        """
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            data_transformation_artifact=DataTransformationArtifact(preprocessor_object_file_path=self.data_transformation_config.preprocessor_object_file_path,
